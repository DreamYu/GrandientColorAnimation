#
#  Be sure to run `pod spec lint GradientColorAnimation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Roy" => "roy.wang@langlive@com" }
  # Or just: s.author    = "Roy"
  # s.authors            = { "Roy" => "roy.wang@langlive@com" }
